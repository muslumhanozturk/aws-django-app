...
DATABASES = {
    'default': {
        ...
        'HOST': 'mhan-django.cmbx1mtdqtib.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'mhan-blog-django' # please enter your s3 bucket name
